...
namespace ThisWarOfMine
{
    public class FilesCoding
    {
        ...
        public static string FolderLoad(string path  )
        {
            try
            {
                ...
                {
                    byte[] fileData = File.ReadAllBytes(path + uzipFileInfo[i].Name);
        ...
        public static void DataPacking(string path)
        {
        ...
        public static void DataCompress()
        {
